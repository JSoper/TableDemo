...
KeyboardEvent.prototype.extspectString = function () {
	...
	if ( "keyCode" in this ) { ux.StringOf.data$ = StringOf.keyCode$( this.keyCode ) + ', ' + this.charCode; }
	return StringOf.embrace$( "KybrdEvent", ux.StringOf.data$ || StringOf.object$( this ) );
};
...
MouseEvent.prototype.extspectString = function () {
	...
	return StringOf.embrace$( "MsEvnt", ux.StringOf.data$ || StringOf.object$( this ) );
};
