...
Ext.define( 'extspect.ExtSpect', {
    ...
    xtype : 'extspect',
    id : 'es-extspect',
    requires : [ 'extspect.view.object.ObjectNavigationView', 'extspect.view.tree.TreeNavigationView', 'extspect.object.rec.BaseRec' ],
    ...
    initialize : function() {
	    ...
	    if ( ! this.app ) {
		    console.error( 'ExtSpect.initialize() did not get a value for the config property app:' );
	    }
